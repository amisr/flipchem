...
class Flipchem():
    ...
    def get_point(self,glat,glon,alt,ne,te,ti,user_no=-1.0,user_nplus=-1.0,msis_outputs=None):
    ...
    def call_flip(self,date,lat,lon,alt,ap,f107a,f107,te,ti,tn,OXN,O2N,N2N,HEN,N4S,NE,user_no=-1.0,user_nplus=-1.0):
        ...
        outputs = _chemion(jprint,yyyyddd,alt,lat,lon,ap,f107,f107a,te,ti,
                           tn,OXN,O2N,N2N,HEN,user_no,0.5*N4S,NE*1.0e-6,
                           user_nplus,utsecs,lthrs,szad)
