...
html_theme_options = {
    ...
    'github_repo': 'flipchem',
    'description': 'A python wrapper of the flipchem ionospheric photochemistry model developed by Phil Richards. Used for fitting ISR data. ',
}
...
latex_documents = [
    (master_doc, 'flipchem.tex', u'flipchem Documentation',
...
man_pages = [
    (master_doc, 'flipchem', u'flipchem Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'flipchem', u'flipchem Documentation',
     author, 'flipchem', 'One line description of project.',
     'Miscellaneous'),
]
